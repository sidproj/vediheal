  ...
  return (
    <div>
      <div style={{ backgroundColor: '#fce4de', color:  '#ff4d4d', padding: '20px' }} className="mt-6">
        <h1 className="color">Privacy Policy</h1>
        ...
        <h2 className="color">What we collect</h2>
        <ul>
          <li>Name and Address for Delivery</li>
          <li>Contact information including email address</li>
          <li>Other information relevant to customer surveys and/or offers</li>
        </ul>
        <h2 className="color">What we do with the information we gather</h2>
        ...
        <h2 className="color">Security</h2>
        ...
        <h2 className="color">Controlling your personal information</h2>
